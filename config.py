...
CONFIG = {
    ...
    "lora_path": "models/sd_xl_offset_example-lora_1.0.safetensors",  # Local path to save LoRA weights
    "debug_dir": "debug_images",  # Directory for debug images
    "yolo_model_path": "yolov8x-face-lindevs.pt",  # YOLO model for face detection
}
