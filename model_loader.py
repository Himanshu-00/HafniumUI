...
#         scheduler_type="DPMSolverMultistepScheduler",  # Base DPM++ scheduler
#         scheduler_config={
#             "algorithm_type": "dpmsolver++",
#             "solver_type": "midpoint",
#             "use_karras_sigmas": True,  # Enable Karras sigmas for better quality
#             "alpha_end": 0.012,  # Fine-tune end noise level
#             "noise_schedule": "karras"  # Use Karras noise schedule
#         }
#     )
#     print("Model loaded successfully.")
...
def load_model_with_lora():
    ...
    # Then configure scheduler separately
    pipeline.scheduler = DPMSolverMultistepScheduler.from_config(
        pipeline.scheduler.config,  # Preserve base config
        algorithm_type="dpmsolver++",
        solver_type="midpoint",
